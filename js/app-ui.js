...
const UI = (() => {
  ...
  function badgeClass(estatus) {
    ...
    return map[estatus] || 'b-pendiente';
  }
  ...
  function updateHeaderCounts() {
    ...
    // "Pendientes" header = everything that is NOT Atendido (todas las empresas activas)
    const pend = all.filter(f => f.estatus !== 'Atendido').length;
